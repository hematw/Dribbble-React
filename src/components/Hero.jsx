...
export default function Hero() {
    return (
        <div className="flex flex-col items-center px-10 py-8 text-center">
            <div className="flex flex-col items-center w-[830px] font-medium">
                <p className="m-14 font-source-serif font-semibold tracking-wide rounded-full bg-pink-300 px-4 py-2">
                    Over 3 million ready-to-work creatives!
                </p>

                <h1 className="font-source-serif text-7xl tracking-wider font-medium">
